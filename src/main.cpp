...
main()
{
  //wifi
    ...
    const char* payload = "/v1/current.json?key=a9e3fb6a760c49699d625304232504&q=Atlanta&aqi=no";
    const char* header = "Accept: application/json";
    wifi.http_get_request(addr, payload, header, resp, 1024);
    printf("%s\n", resp);
    printf("Finished.");
